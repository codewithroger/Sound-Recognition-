...
# Load metadata
metadata = pd.read_csv('D:/MegaProject/archive/UrbanSound8K.csv')
...
for index, row in metadata.iterrows():
    file_name = os.path.join('D:/MegaProject/archive', f'fold{row["fold"]}', row["slice_file_name"])
...
model.save('D:/MegaProject/saved_models/urban_sound_classifier.h5')

# Save the LabelEncoder for later use
import joblib
joblib.dump(le, 'D:/MegaProject/saved_models/label_encoder.pkl')
...
random_file_name = 'D:/MegaProject/archive/fold1/7061-6-0-0.wav'
