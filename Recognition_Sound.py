...
# Load metadata
metadata = pd.read_csv('D:/Sound_Recognition/archive/UrbanSound8K.csv')
...
for index, row in metadata.iterrows():
    file_name = os.path.join('D:/Sound_Recognition/archive', f'fold{row["fold"]}', row["slice_file_name"])
